 ...
 **/
KISSY.add('kg/KOnepageScroll/2.0.0/index',function (S, Node, Base) {
    var EMPTY = '';
    var $ = Node.all,
        el,
        sections,
    ...
    /**
     * 
     * @class KOnepageScroll
     * @constructor
     * @extends Base
     */
    function KOnepageScroll(comConfig) {
        var self = this;
        //调用父类构造函数
        KOnepageScroll.superclass.constructor.call(self, comConfig);
        self.init();
    }
    S.extend(KOnepageScroll, Base, /** @lends KOnepageScroll.prototype*/{
        ...
        moveUp: function() {
            ...
            if (next.length < 1) {
                ...
                pos = ((next.attr("data-index") - 1) * 2.0.0) * -1;
            }
